    ...
    <div id="main-panel" class="col-md-9">
        ...
        <div id="factories" class="box-btn-row">
            ...
            <div id="dynamic-factories">
                ...
                <%--<div class="box-btn-wrapper">--%>
                    <%--<button class="box-btn factory" onclick="selectFactory('ABC Factory', this)">ABC Factory</button>--%>
                <%--</div>--%>
                <%--<div class="box-btn-wrapper">--%>
                    <%--<button class="box-btn factory" onclick="selectFactory('Cocacola Factory', this)">Cocacola Factory</button>--%>
                <%--</div>--%>
                <%--<div class="box-btn-wrapper">--%>
                    <%--<button class="box-btn factory" onclick="selectFactory('Bata Shoe Factory', this)">Bata Shoe Factory</button>--%>
                <%--</div>--%>
            </div>
